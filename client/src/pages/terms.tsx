      ...
      <main className="max-w-4xl mx-auto px-4 py-10 sm:py-16">
        ...
        {lang === "ar" ? (
          <div className="prose prose-zinc dark:prose-invert max-w-none space-y-8 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3">4. رصيد الذكاء</h2>
              <p>تعمل المنصة بنظام رصيد الذكاء (جلسات ذكاء اصطناعي) لاستخدام خدمات الذكاء الاصطناعي:</p>
              <ul className="list-disc ps-6 space-y-1 mt-2">
                <li>إنشاء موقع أو تعديل ذكي أو توليد محتوى تسويقي = جلسة ذكاء واحدة</li>
                <li>توليد صورة بوست بالذكاء الاصطناعي (DALL-E) = جلستَا ذكاء</li>
                <li>جلسات الذكاء غير قابلة للتحويل أو الاسترداد</li>
                <li>يتم تجديد رصيد الذكاء شهرياً حسب خطة الاشتراك</li>
                <li>الجلسات غير المستخدمة لا تُرحّل للشهر التالي</li>
              </ul>
            </section>
            <section>
