...
<script id="aw-mobile-nav">(function(){
  ...
  function init(){
    ...
    btn.innerHTML=mSvg;
    btn.style.cssText='border:none;border-radius:8px;cursor:pointer;padding:7px;display:block!important;flex-shrink:0;line-height:1;background:'+btnBg+';color:'+iconColor+';';
