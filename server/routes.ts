...
--------------------
١. قم بتحميل ملف الموقع المضغوط.
٢. فك الضغط عن الملف.
٣. ادخل إلى لوحة تحكم الاستضافة (مثل Hostinger أو cPanel).
٤. افتح File Manager.
٥. ارفع جميع الملفات من مجلد "website" إلى مجلد public_html.
٦. تأكد أن ملف index.html موجود في المجلد الرئيسي.
٧. افتح الدومين في المتصفح وسيعمل الموقع.

للنشر على Netlify أو Vercel:
١. اذهب إلى netlify.com أو vercel.com
٢. اسحب وأفلت مجلد "website"
٣. سيتم نشر موقعك فوراً
